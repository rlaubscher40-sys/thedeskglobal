...
const CATEGORY_ACCENT: Record<string, string> = {
  ...
  "GLOBAL PUBLIC PULSE": "rgba(167,139,250,0.8)",
...
const CATEGORY_BG: Record<string, string> = {
  ...
  "GLOBAL PUBLIC PULSE": "rgba(167,139,250,0.06)",
...
const CATEGORY_PILL: Record<string, string> = {
  ...
  AI:                  "text-cyan-400 bg-cyan-500/10 border-cyan-500/25",
  ...
  GEOPOLITICS:         "text-red-400 bg-red-500/10 border-red-500/25",
  CULTURE:             "text-pink-400 bg-pink-500/10 border-pink-500/25",
  SPORT:               "text-lime-400 bg-lime-500/10 border-lime-500/25",
  SPORTS:              "text-lime-400 bg-lime-500/10 border-lime-500/25",
  "GLOBAL PUBLIC PULSE": "text-violet-400 bg-violet-500/10 border-violet-500/25",
  CRYPTO:              "text-yellow-400 bg-yellow-500/10 border-yellow-500/25",
  HEALTH:              "text-teal-400 bg-teal-500/10 border-teal-500/25",
  CLIMATE:             "text-green-400 bg-green-500/10 border-green-500/25",
